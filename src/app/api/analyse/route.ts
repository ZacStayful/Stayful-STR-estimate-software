...
export async function POST(request: Request) {
  ...
  // SaaS gate: require an authed user whose trial is active or who is on Pro.
  // The calibration bypass is preserved so internal calibration scripts that
  // ship a shared dev secret can still hit the route without a session.
